    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mt-16 mb-8">
                <div className="p-4 rounded-lg border text-center flex flex-col items-center justify-center"data-aos="zoom-in"data-aos-duration="1000">
                    ...
                    <div className="flex mb-3 gap-4 clr text-2xl text-center mt-2"data-aos="zoom-in"data-aos-duration="1000">
                        <FaFacebook /> 
                        <FaSquareXTwitter />
                        <FaInstagramSquare />
                        <FaLinkedin />
